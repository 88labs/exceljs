...
class WorksheetWriter {
  constructor(options) {
    ...
    this.printOptions = Object.assign(
      {},
      {
        headings: options.pageSetup && options.pageSetup.showRowColHeaders,
        gridLines: options.pageSetup && options.pageSetup.showGridLines,
        horizontalCentered: options.pageSetup && options.pageSetup.horizontalCentered,
        verticalCentered: options.pageSetup && options.pageSetup.verticalCentered,
      }
    );
  ...
  _writePrintOptions() {
    this.stream.write(xform.printOptions.toXml(this.printOptions));
  }
